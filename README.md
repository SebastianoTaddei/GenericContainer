...
Fork of [Generic Container](https://github.com/ebertolazzi/GenericContainer) by Enrico Bertolazzi.
...
```bash
git clone --branch stable --depth 1 https://github.com/SebastianoTaddei/GenericContainer.git
cd GenericContainer
ruby setup.rb
rake
```
